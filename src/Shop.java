import component.*;
import component.storage.HDD;
import component.storage.SSD;
import component.storage.Storage;

import java.util.List;

public class Shop {
    public List<CPU> cpuList = List.of(
            new CPU(
                    "i9 14900K",
                    697930,
                    253,
    ...
    public List<Mainboard> mainboardList = List.of(
            new Mainboard(
                    "MSI Z790 EDGE WIFI",
                    369000,
                    120,
    ...
    public List<RAM> ramList = List.of(
    ...
    public List<GPU> gpuList = List.of(
    ...
    public List<Storage> storageList = List.of(
    ...
    public List<PowerSupply> powerSupplyList = List.of(
